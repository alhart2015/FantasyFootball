# Feature signal probe — pbp_redzone_lgbnb_swap
...
|---|---|---|---|---:|
| QB | DO_NOT_ADOPT | +0.0114 ([-0.0062, +0.0293]) | -0.0032 ([-0.0069, +0.0002]) | 2692 |
| RB | DO_NOT_ADOPT | +0.0019 ([-0.0067, +0.0116]) | +0.0003 ([-0.0014, +0.0020]) | 5273 |
| WR | DO_NOT_ADOPT | +0.0004 ([-0.0057, +0.0067]) | -0.0000 ([-0.0013, +0.0013]) | 8470 |
| TE | DO_NOT_ADOPT | +0.0006 ([-0.0082, +0.0094]) | -0.0036 ([-0.0067, -0.0007]) | 4257 |
