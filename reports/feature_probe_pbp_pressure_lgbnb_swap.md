...
C:\Users\alden\FantasyFootball\.worktrees\feat-probe-pbp-pressure\.venv\Lib\site-packages\sklearn\utils\validation.py:2691: UserWarning: X does not have valid feature names, but LGBMRegressor was fitted with feature names
  warnings.warn(
# Feature signal probe — pbp_pressure_lgbnb_swap
...
|---|---|---|---|---:|
| QB | DO_NOT_ADOPT | +0.0125 ([-0.0053, +0.0313]) | -0.0031 ([-0.0070, +0.0005]) | 2692 |
| RB | DO_NOT_ADOPT | +0.0031 ([-0.0050, +0.0117]) | -0.0003 ([-0.0017, +0.0011]) | 5273 |
| WR | DO_NOT_ADOPT | -0.0012 ([-0.0074, +0.0058]) | +0.0009 ([-0.0006, +0.0024]) | 8470 |
| TE | DO_NOT_ADOPT | +0.0053 ([-0.0058, +0.0169]) | -0.0034 ([-0.0067, -0.0002]) | 4257 |
