# Feature signal probe — weather_refined_lgbnb_swap
...
| RB | ADOPT | -0.0088 ([-0.0153, -0.0030]) | +0.0005 ([-0.0005, +0.0016]) | 5273 |
| WR | ADOPT | -0.0050 ([-0.0098, -0.0006]) | +0.0004 ([-0.0006, +0.0012]) | 8470 |
