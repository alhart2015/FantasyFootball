...
C:\Users\alden\FantasyFootball\.worktrees\feat-probe-pbp-pressure\.venv\Lib\site-packages\sklearn\utils\validation.py:2691: UserWarning: X does not have valid feature names, but LGBMRegressor was fitted with feature names
  warnings.warn(
# Feature signal probe — rb_pbp_track2b_lgbnb

Baseline features: data\features
Overrides:        data\features_probe\rb_pbp_track2b.parquet
Drops:            pace_l4, proe_l4, team_ayps_l4, team_def_epa_resid_l4
...
|---|---|---|---|---:|
| RB | DO_NOT_ADOPT | +0.0000 ([+0.0000, +0.0000]) | +0.0000 ([+0.0000, +0.0000]) | 5273 |
