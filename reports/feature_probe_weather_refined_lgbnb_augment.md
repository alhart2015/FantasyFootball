# Feature signal probe — weather_refined_lgbnb_augment
...
|---|---|---|---|---:|
| QB | DO_NOT_ADOPT | +0.0099 ([+0.0002, +0.0202]) | -0.0018 ([-0.0039, +0.0003]) | 2692 |
| RB | DO_NOT_ADOPT | +0.0026 ([-0.0036, +0.0081]) | -0.0001 ([-0.0010, +0.0009]) | 5273 |
| WR | ADOPT | -0.0051 ([-0.0097, -0.0006]) | -0.0005 ([-0.0013, +0.0004]) | 8470 |
| TE | DO_NOT_ADOPT | +0.0053 ([-0.0006, +0.0110]) | -0.0012 ([-0.0027, +0.0004]) | 4257 |
