...
### 54. DFS Engine — Layer 1 projection edge study — ✅ SHIPPED (harness), ⏸ verdict DEFERRED (branch `feat/dfs-projection-edge-study`)
...
### 39. Fair weekly start/sit benchmark — does our weekly model beat ESPN weekly? (SUPERSEDED by #54's method; verdict pending)
